...
public:
    ...
    void setupUi(QDialog *FaceRecognitionDialog)
    {
        ...
        FaceRecognitionDialog->resize(857, 418);
        QIcon icon;
        ...
        resultsTableWidget->setGeometry(QRect(480, 40, 361, 331));
        ...
        groupBox_2->setGeometry(QRect(10, 170, 461, 201));
