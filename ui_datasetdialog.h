...
public:
    ...
    void setupUi(QDialog *DatasetDialog)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("res/icons/select.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        catalogDisplayTableWidget->setGeometry(QRect(10, 111, 381, 201));
        ...
        searchTextEdit->setGeometry(QRect(287, 83, 104, 31));
        ...
        tableWidget->setGeometry(QRect(10, 151, 381, 161));
        ...
        datasetDescriptionLabel->setGeometry(QRect(50, 10, 341, 71));
